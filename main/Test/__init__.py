###############################################################################################
# Over view on test file:
# 1. AbstractParserTest -  has setUpCls, setUp, test method(s),  tearDown, tearDownCls
# 2. JsonParserTest - has setUpCls, setUp, test method(s),  tearDown, tearDownCls
# 3. XMLParserTest - has setUpCls, setUp, test method(s),  tearDown, tearDownCls
# 4. CSVParserTest - has setUpCls, setUp, test method(s),  tearDown, tearDownCls
# 5. DataManagerFactoryTest - has setUpCls, setUp, test method(s),  tearDown, tearDownCls
...
class DataManagerFactoryTest(unittest.TestCase):
    ...
    def test_call_parser_and_is_Empty(self):
        """
        Helps to test:-
        1) Empty Entity Collection
        2) Non Empty Entity Collection scenario
        3) with unknown parser
        4) Non Empty Entity with empty field scenario
        :return:
        """
